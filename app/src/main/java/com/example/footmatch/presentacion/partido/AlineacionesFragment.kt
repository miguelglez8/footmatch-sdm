...
import coil.load
import com.example.footmatch.presentacion.adapters.ListaJugadoresAdapter
import com.example.footmatch.R
import com.example.footmatch.datos.modelos.partido.MatchToShow
import com.example.footmatch.datos.modelos.partido.Squad
...
class AlineacionesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        plantilla1 = root.findViewById(R.id.plantilla1)
        plantilla2 = root.findViewById(R.id.plantilla2)
