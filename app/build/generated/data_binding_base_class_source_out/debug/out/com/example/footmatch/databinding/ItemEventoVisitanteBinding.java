...
public final class ItemEventoVisitanteBinding implements ViewBinding {
  @NonNull
  ...
  private ItemEventoVisitanteBinding(@NonNull LinearLayout rootView, @NonNull ImageView icono1,
  ...
  @NonNull
  public static ItemEventoVisitanteBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemEventoVisitanteBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_evento_visitante, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemEventoVisitanteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEventoVisitanteBinding((LinearLayout) rootView, icono1, icono2, minutoEvento,
